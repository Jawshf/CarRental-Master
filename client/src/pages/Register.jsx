                ...
                {page === 0 ? <>
                    <h2 className="text-xl font-bold font-sans my-6">Create an account</h2>
                        ...
                        <div className="my-4 w-full flex justify-center">
                            <button type="button" onClick={HandleClick} className="px-14 py-3 bg-orange opacity-95 text-white hover:opacity-100 rounded hover:shadow-xl font-bold ">Continue with email</button>
                        </div>
                        ...
                        <div className="my-4 w-full flex justify-center">
                            <button type="button" onClick={Submit} className="px-14 py-3 bg-orange opacity-95 text-white hover:opacity-100 rounded hover:shadow-xl font-bold ">Create account</button>
                        </div>  
                        </>
                }
            </div>
